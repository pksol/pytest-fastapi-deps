...
```bash
cd pytest-fastapi-deps && git init
```
...
git branch -M main
git remote add origin https://github.com/pksol/pytest-fastapi-deps.git
...
- [`Poetry`](https://python-poetry.org/) as the dependencies manager. See configuration in [`pyproject.toml`](https://github.com/pksol/pytest-fastapi-deps/blob/master/pyproject.toml) and [`setup.cfg`](https://github.com/pksol/pytest-fastapi-deps/blob/master/setup.cfg).
...
- Ready-to-use [Pull Requests templates](https://github.com/pksol/pytest-fastapi-deps/blob/master/.github/PULL_REQUEST_TEMPLATE.md) and several [Issue templates](https://github.com/pksol/pytest-fastapi-deps/tree/master/.github/ISSUE_TEMPLATE).
- Files such as: `LICENSE`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, and `SECURITY.md` are generated automatically.
- [`Stale bot`](https://github.com/apps/stale) that closes abandoned issues after a period of inactivity. (You will only [need to setup free plan](https://github.com/marketplace/stale)). Configuration is [here](https://github.com/pksol/pytest-fastapi-deps/blob/master/.github/.stale.yml).
...
[`Makefile`](https://github.com/pksol/pytest-fastapi-deps/blob/master/Makefile) contains a lot of functions for faster development.
...
You can update it in [`release-drafter.yml`](https://github.com/pksol/pytest-fastapi-deps/blob/master/.github/release-drafter.yml).
